...
bool FactoryMeshDX10::loadMeshesFromOBJ(const char* filePath) {
...
bool FactoryMeshDX10::loadMeshesFromMeshFile(const char* filePath) {
	FILE* file = NULL;
...
bool FactoryMeshDX10::convertOBJToMeshFile(const char* inFile, const char* outFile) {
	if(resMen == NULL) return false;
	OBJLOADER_OBJECT ob;
